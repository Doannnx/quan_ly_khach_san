    ...
    public void getTableSelectedUpdate() {
        ...
        view.updateItemListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                updateEmployee.setOnlyNumberAge(new KeyAdapter() {
                ...
                updateEmployee.setOnlyNumberSalary(new KeyAdapter() {
                    public void keyTyped(KeyEvent e) {
                        char c = e.getKeyChar();
                        if (!(Character.isDigit(c) || (c == KeyEvent.VK_BACK_SPACE) || (c == KeyEvent.VK_DELETE))) {
                            e.consume();
                ...
                updateEmployee.setOnlyNumberPhone(new KeyAdapter() {
                    public void keyTyped(KeyEvent e) {
                        char c = e.getKeyChar();
                        if (!(Character.isDigit(c) || (c == KeyEvent.VK_BACK_SPACE) || (c == KeyEvent.VK_DELETE))) {
                            e.consume();
                ...
                updateEmployee.clickUpdate(new ActionListener() {
                    @Override
                    public void actionPerformed(ActionEvent e) {
                        Employee employeeUpdateText = updateEmployee.getTextUpdate();
                        if (employeeUpdateText.getAge() == -1 || employeeUpdateText.getSalary() == -1 || employeeUpdateText.getEmployeeID().isEmpty() || employeeUpdateText.getName().isEmpty() || employeeUpdateText.getNumberPhone().isEmpty() || employeeUpdateText.getPosition().isEmpty()) {
                            JOptionPane.showMessageDialog(updateEmployee, "Không được để trống bất kì ô nào", "Thông báo", JOptionPane.WARNING_MESSAGE);
                            return;
                        } else {
                            data.updateEmployee(employeeUpdateText);
                            refreshTable();
